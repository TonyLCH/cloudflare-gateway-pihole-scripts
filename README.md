...
2. Create the following GitHub Actions secrets in your repository settings:
   ...
   - `CLOUDFLARE_LIST_ITEM_LIMIT`: The maximum number of blocked domains allowed for your Cloudflare Zero Trust plan. Defaults to 300,000 if not specified. Values above 300,000 are automatically capped to 300,000 to avoid API errors on plans with this limit.
